 ...
 * (=클래스 변수/메서드) 만약 static멤버변수는 명시적으로 초기화를 안하면 기본값이 저장됨
...
public class Book {
	...
	static final int PRICE_BOOK=10000;//static멤버변수:Book 클래스가 메모리에 로딩할 때 초기화되어 올라감//static final + 변수 = 상수. 이 경우 변수명을 대문자로 적어야함.(반드시는 아님.)
